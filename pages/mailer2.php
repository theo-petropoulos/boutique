...
require realpath($_SERVER["DOCUMENT_ROOT"]) . '/boutique/model/ManWatch.php';
require realpath($_SERVER["DOCUMENT_ROOT"]) . '/boutique/model/Watch.php';
...
<td>' . $nom_produit . ' - ' . $marque . '</td>
<td class="cost">' . $prix . '€</td>
<td class="cost">' . $total1 . '€</td>
</tr>
'}'
